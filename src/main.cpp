...
uint256 hashGenesisBlock("0x47efc7bdc8477239bf43162f384ef0cef158f471a9ccd109794d86a3116fc9f0");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Daikicoin: starting difficulty is 1 / 2^12
...
static const int64 nTargetTimespan = 302400; // Daikicoin: 3.5 days
static const int64 nTargetSpacing = 120; // Daikicoin: 2.5 minutes
...
{
    // Daikicoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x9865e8b9d46e8cd7fc1e042f3f74f0684c27e535e8b8a057834e503a3a557bb3");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Another illustrious dic-a-Coin cryptocurrency!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("9b2454a2d233a83519ad70fd250b8f0af28e85c7708cb514a568183fccce8e02e0b9bcc7840f9b9b3f41658acad2962fb1b535ac9941c4e16d88ea52e25599985e") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1516352183;
        block.nBits    = 504365644;
        block.nNonce   = 3816021691;

        if (fTestNet)
        {
            block.nTime    = 1516352183;
            block.nNonce   = 721362839;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x7bda39c1f5517ccf4935eb0e74eaf964dbf4eb82484a50d673287a1c13d80da7"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Daikicoin: increase each by adding 2 to bitcoin's value.
